  ...
  return (
    <>
      {uploadedImages.length === 0 ? (
        <ChatModal uploadedImages={uploadedImages} setUploadedImages={setUploadedImages} showChatInput={showChatInput} conversions={conversions} inputValue={inputValue} setInputValue={setInputValue} handleForm={handleForm} placeHolder={`i.e. ‘living room’`} />
      ) : (
